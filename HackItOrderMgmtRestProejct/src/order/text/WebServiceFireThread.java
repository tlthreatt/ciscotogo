...
public class WebServiceFireThread implements Runnable {

    File request;
    Dispatch<Source> dispatch;
    public WebServiceFireThread() {
    }
	...
	public void run() {
		...
		orderLines.add(new OrderLineItemRepresentation(null,new Long(2), 13.0));
		orderLines.add(new OrderLineItemRepresentation(null,new Long(2), 13.0));
		OrderRepresentation orderRep = new OrderRepresentation(null, "SUBMITTED", new Date(), new Long(1), "eyaklin", new Long(2), orderLines);
