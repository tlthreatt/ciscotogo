...
<script src="/ciscotogo/resources/metronic_assets/scripts/custom3.js"></script>
<!-- END JAVASCRIPTS -->
...
<!-- 								</div> -->
			...
			<div id="mb-title-nav-bar" class="clearfix">
				<div id="framework-content-titles">
					<!--googleon: index-->
					<!--googleon: snippet-->
					<h1 class="title-section">Menu for -building-</h1>
					<!--googleoff: index-->
					<!--googleoff: snippet-->
				</div>
			</div>
								...
								<!--googleon: index-->
									...
									<div id="framework-content-main">
										...
										<div class="container">
											...
											<div class="row">
												<div class="modal fade" id="addMenuItemPopup"
